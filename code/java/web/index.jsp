        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="create-list">
                    <div class='row'>
                        <div class="col-md-5">
                            <input type="text" id="list-name" placeholder="Name" aria-label="Name"/>
                        </div>
                    </div>
                    <div class='row'>
                        <div class="col-md-5">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="create-product">
                    <div class='row'>
                        <div class="col-md-5">
                            <input type="text" id="product-name" placeholder="Name" aria-label="Name"/>
                        </div>
                    </div>
                    <div class='row'>
                        <div class="col-md-5">
                    ...
                    <div class='row'>
                        <div class="col-md-5">
                            <h4>Logo</h4><input type="file" style="font-size: 15px;"/>
                        </div>
                    </div>
                    <br>
                    <div class='row'>
...
%>
                <tr>
                    ...
                    <td style="width:40%; padding-left:10px;">
                        <h4>
<%
            if(privileges.getInt("permission") == 0){
%>
                            Owner
<%
            }
